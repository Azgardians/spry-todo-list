...
function Board() {
  const data = getData()
  console.log(columns);
  const overdue = "2 tasks are due for tomorrow"
  return (
    <>
          ...
          <TabsContent value="todo">
            <Card>
              <div className="flex flex-col">
                {/* this will contain a summary section and action button to add new todo */}
                <Summary completed={12} total={data.length} overdue={overdue} />
                {/* <Separator className="my-4" /> */}
                {/* this will contain table and filters */}
